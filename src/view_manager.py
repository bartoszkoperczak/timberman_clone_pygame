...
class ViewManager:
    def __init__(self):
        """Initialize the ViewManager and set up the main display surfaces."""
    ...
    def change_view(self, new_view: Drawable):
        """Change the current view to a new Drawable view."""
    ...
    def draw(self):
        """Draw the current view to the screen, scaling as needed."""
