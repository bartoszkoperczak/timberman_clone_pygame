...
class UIManager:
    ...
    def create_main_menu(self):
        self.buttons = [
            Button(100, 100, self.assets['singleplayer'], self.game_window.start_singleplayer),
            Button(100, 180, self.assets['multiplayer'], self.show_multiplayer_menu),
            Button(100, 260, self.assets['settings'], self.show_settings),
            Button(100, 340, self.assets['quit'], self.quit_game)
        ]
        self.current_screen = 'main'

    def show_multiplayer_menu(self):
        self.buttons = [
            Button(100, 100, self.assets['1vs1'], self.game_window.start_1vs1),
            Button(100, 180, self.assets['1vsbot'], self.game_window.start_1vsbot),
            Button(100, 260, self.assets['return'], self.create_main_menu),
        ]
    ...
    def show_settings(self):
        ...
        self.buttons = [
            Button(100, 100, self.assets['return'], self.create_main_menu),
        ]
